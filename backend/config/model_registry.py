...
MODEL_REGISTRY: dict[str, ModelConfig] = {
    "gemma2:2b": ModelConfig(context_window=4096, max_output=512, safe_context=3000, temperature=0.1),
...
DEFAULT_MODEL_CONFIG = ModelConfig(context_window=4096, max_output=512, safe_context=3000, temperature=0.1)
