...
MODEL_REGISTRY: dict[str, ModelConfig] = {
    "gemma2:2b": ModelConfig(context_window=2048, max_output=1024, safe_context=1500, temperature=0.1),
...
DEFAULT_MODEL_CONFIG = ModelConfig(context_window=2048, max_output=1024, safe_context=1500, temperature=0.1)
