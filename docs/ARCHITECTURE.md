...
### Ollama
Контейнер для LLM. По умолчанию — модель из переменной `LLM_MODEL` (рекомендуется `qwen3:8b`). Изолирован от бэкенда для квотирования ресурсов.
...
| `qwen3:8b` | 8192 | 1200 | 2000 | 3 | нет |
| `qwen3:14b` | 16384 | 1500 | 3000 | 4 | нет |
